    ...
    <div>
      ...
      <div className="about">
        ...
        <p>
          ...
          <span>Front-End Developer</span> passionate about building, enhancing,
          and maintaining seamless software solutions. I work primarily with{" "}
          <span>Javascript, its frameworks</span> and other relevant front-end
          tools. I excel in collaborating with designers and developers to
          create user interfaces and implementing APIs that align with project
          goals and requirements. With expertise in code reviews and
          troubleshooting. I stay committed to keeping up with emerging
          ...
          experience as a <span>Front-End Developer</span>, i have learnt quite
          a lot about the craft and it's best practices.
        </p>
        <br />
        <p>
